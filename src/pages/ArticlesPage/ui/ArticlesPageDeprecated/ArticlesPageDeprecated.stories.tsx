...
export default {
    title: 'pages/Articles/ArticlesPage/ArticlesPageDeprecated',
    component: ArticlesPageDeprecated,
    argTypes: {
...
} as ComponentMeta<typeof ArticlesPageDeprecated>;

const Template: ComponentStory<typeof ArticlesPageDeprecated> = (args) => <ArticlesPageDeprecated {...args} />;
